...
const ToolTip: FC<Props> = ({ children, tooltip }): JSX.Element => {
  ...
  return (
    ...
    {children}
    <div className="absolute left-1/2 top-5 ml-auto mr-auto min-w-max -translate-x-1/2 scale-0 transform rounded-lg px-3 py-2 text-xs font-medium transition-all duration-500 group-hover:scale-100 z-10">
