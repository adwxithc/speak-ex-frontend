                ...
                <div className=" rounded overflow-hidden  shadow-md hover:scale-105 transition-all">
                  ...
                  <div className="bg-gray-200/30 p-2 ">
                    ...
                    <div className="flex justify-center">
                      <Button onClick={()=>handleCheckout(plan.id)} className="rounded border w-full    hover:shadow-black/20"   ><span className="font-bold text-black/70 py-1">Buy {plan.price} rs</span></Button>
                    </div>
